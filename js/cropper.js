...
(function (factory) {
  ...
  $.extend(prototype, {
    build: function () {
      ...
      this.$cropBox = $cropBox = this.$container.append(
  ...
  $.extend(prototype, {
    initPreview: function () {
      ...
      this.$viewBox.html(getSourceCanvas(this.$clone[0], this.image));
  ...
  $.extend(prototype, {
    ...
    desaturateCanvasObj: function () {
      var canvas = this.$viewBox.find('canvas')[0],
          context = canvas.getContext('2d'),
          imageData = context.getImageData(0, 0, canvas.width, canvas.height),
          data = imageData.data;

        for(var i = 0; i < data.length; i += 4) {
          this.coloredCanvasData[i] = data[i];
          this.coloredCanvasData[i+1] = data[i+1];
          this.coloredCanvasData[i+2] = data[i+2];
    ...
    saturateCanvasObj: function () {
      var canvas = this.$viewBox.find('canvas')[0],
          context = canvas.getContext('2d'),
          canvasObjData = this.getCanvasData(),
          imageData = context.getImageData(0, 0, canvas.width, canvas.height),
          data = imageData.data;

          for(var i = 0; i < data.length; i += 4) {
              // red
              data[i] = this.coloredCanvasData[i];
              // green
              data[i + 1] = this.coloredCanvasData[i+1];
              // blue
              data[i + 2] = this.coloredCanvasData[i+2];
          }
    ...
    getCroppedCanvas: function (options) {
      ...
      context.drawImage.apply(context, (function () {
        var source = this.$viewBox.find('canvas')[0];
