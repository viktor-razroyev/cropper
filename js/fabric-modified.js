...
fabric.Text = fabric.util.createClass(fabric.Object, /** @lends fabric.Text.prototype */ {
    ...
    _getRieslingSymWidth: function(char) {
      var widthObject = {
        letter_A: 0.245964913619192,
        letter_B: 0.40192983526932563,
        letter_D: 0.48596492566560445,
        letter_E: 0.2029824507863898,
        letter_F: 0.20192981519197162,
        letter_G: 0.6670175251207854,
        letter_H: 0.23491229007118627,
        letter_I: 0.09807017476935136,
        letter_J: 0.245964913619192,
        letter_K: 0.2340350903962788,
        letter_L: 0.2029824507863898,
        letter_M: 0.35491228605571545,
        letter_N: 0.27491228204024465,
        letter_O: 0.6640350743343956,
        letter_P: 0.4,
        letter_Q: 0.6670175251207854,
        letter_R: 0.40192983526932563,
        letter_S: 0.47000001606188324,
        letter_T: 0.23491229007118627,
        letter_U: 0.24491227802477386,
        letter_V: 0.24491227802477386,
        letter_W: 0.4,
        letter_X: 0.2849122900711863,
        letter_Y: 0.24894736440558182,
        letter_Z: 0.2629824588173314,
        symbol_123: 0.16298245881733142,
        symbol_124: 0.0900000020077354,
        symbol_32: 0.30508772197522616,
        symbol_33: 0.09403508838854338,
        symbol_35: 0.2629824588173314,
        symbol_36: 0.3570175572445518,
        symbol_37: 0.7029824507863898,
        symbol_38: 0.47000001606188324,
        symbol_39: 0.0900000020077354,
        symbol_40: 0.13491228003250924,
        symbol_41: 0.13596491562692742,
        symbol_42: 0.2029824507863898,
        symbol_43: 0.2029824507863898,
        symbol_44: 0.122982456809596,
        symbol_45: 0.2029824507863898,
        symbol_46: 0.122982456809596,
        symbol_47: 0.27807016874614515,
        symbol_58: 0.122982456809596,
        symbol_59: 0.122982456809596,
        symbol_61: 0.2029824507863898,
        symbol_63: 0.47000001606188324,
        symbol_64: 0.6589473523591695,
        symbol_91: 0.12701754319040398,
        symbol_92: 0.27807016874614515,
        symbol_93: 0.12701754319040398,
        symbol_94: 0.122982456809596,
        symbol_95: 0.4        
      },
      charWidth;

      if (/[A-Z]/.test(char)) {
        charWidth = widthObject['letter_' + char];
      } else if (widthObject['symbol_' + char.charCodeAt(0)]) {
        charWidth = widthObject['symbol_' + char.charCodeAt(0)];            
      } else {
        return ctx.measureText(char).width;
      }
      charWidth = charWidth * this.fontSize;
    ...
    _renderChars: function(method, ctx, chars, left, top) {
      ...
      var shortM = method.slice(0, -4),
        ...
        actualWidth = 0,
        actualChars = chars.toUpperCase(),
        letterSpace2 = this.letterSpace/2;

      for (var i = 0; i < actualChars.length; i++) {
        actualWidth += this.letterSpace + this._getRieslingSymWidth(actualChars.charAt(i), ctx);
      ...
      var charShift = this.letterSpace,
          charWidth;
      for (var i = 0; i < actualChars.length; i++) { 
          var util = (i == 0) ? 0 : letterSpace2;
          if (((actualChars.charAt(i) == 'Q') || (actualChars.charAt(i) == 'C') || (actualChars.charAt(i) == 'D') || (actualChars.charAt(i) == 'G') || (actualChars.charAt(i) == 'O'))) {
            util = -letterSpace2 * 1.4;
          }    
          if (actualChars.charAt(i) == 'P') {
            util = -letterSpace2 * 0.6;
          }  
          if (actualChars.charAt(i) == 'S') {
            util = -letterSpace2 * 1.2;
          }  
          if (actualChars.charAt(i) == 'M') {
            util = -letterSpace2 * 0.45;
          }  
          if ((actualChars.charAt(i) == 'N') || (actualChars.charAt(i) == 'A')) {
            util = letterSpace2 * 0.4;
          }  
          if (actualChars.charAt(i) == 'B') {
            util = -letterSpace2 * 0.7;
          } 
          ctx[method](actualChars.charAt(i), left + charShift - util, top); 

          charShift += this._getRieslingSymWidth(actualChars.charAt(i), ctx) + this.letterSpace;  

          /*         
          if (!this._deleteObject['letter-' + actualChars.charAt(i)]) {
            if (/[A-Z]/.test(actualChars.charAt(i))) {
              this._deleteObject['letter-' + actualChars.charAt(i)] = ctx.measureText(actualChars.charAt(i)).width/this.fontSize;
            } else {
              this._deleteObject['symbol-' + actualChars.charAt(i).charCodeAt(0)] = ctx.measureText(actualChars.charAt(i)).width/this.fontSize;              
            }
            
          }*/
      } 

      if (actualWidth > this.maxInputWidth) {
        this.setScaleX(this.maxInputWidth/actualWidth)
      } else {
        this.setScaleX(1)
      }
    ...
    _renderTextLine: function(method, ctx, line, left, top, lineIndex) {
      ...
      top += (this.fontSize * this.selectionHeightPercent * 1.2 - this.fontSize)/1.7;
...
(function() {
  ...
  fabric.IText = fabric.util.createClass(fabric.Text, fabric.Observable, /** @lends fabric.IText.prototype */ {
    ...
    _getCursorBoundariesOffsets: function(chars, typeOfBoundaries) {
      ...
      return {
        top: topOffset,
        left: leftOffset/* - this.letterSpace/2*/,
    ...
    renderCursor: function(boundaries, ctx) {
      ...
      ctx.fillRect(
        boundaries.left + leftOffset - this.letterSpace/2,
        boundaries.top + boundaries.topOffset + (charHeight * (1 - this.cursorHeightPercent))/1.58 ,
        this.cursorWidth / this.scaleX,
        charHeight * this.cursorHeightPercent);
    ...
    renderSelection: function(chars, boundaries, ctx) {
      ...
      for (var i = startLine; i <= endLine; i++) {
        ...
        ctx.fillRect(
          boundaries.left + lineOffset - this.letterSpace/2,
          boundaries.top + boundaries.topOffset + lineHeight * 0.06,
          boxWidth,
          lineHeight - lineHeight * 0.12);
    ...
    _applyCharStylesGetWidth: function(ctx, _char, lineIndex, charIndex, decl) {
      ...
      if (!this.caching || !this._charWidthsCache[cacheProp]) {
        ...
        width = this._getRieslingSymWidth(_char, ctx);
        //console.log(ctx.measureText(_char).width, width);
    ...
    _getWidthOfChar: function(ctx, _char, lineIndex, charIndex) {
      ...
      if (this._charWidthsCache[cacheProp] && this.caching) {
        ...
        var width = this._applyCharStylesGetWidth(ctx, _char.toUpperCase(), lineIndex, charIndex) + this.letterSpace;
    ...
    /*
      ...
      */
      this.__lineHeights[lineIndex] = this.fontSize * this.selectionHeightPercent * 1.2;
...
(function() {
  ...
  fabric.util.object.extend(fabric.IText.prototype, /** @lends fabric.IText.prototype */ {
    ...
    _addInputBorders: function() {
      this._inputRect =  new fabric.Rect({
        fill: 'transparent',
        left: this.left - this.maxInputWidth/2 -18,
        top: this.top - (this.fontSize * this.selectionHeightPercent * 1.2)/2,
        width: this.maxInputWidth + 30,
        height: this.fontSize * this.selectionHeightPercent * 1.2,
      ...
      this.canvas.add(this._inputRect);
    },
    _removeInputBorders: function() {
      this.canvas.remove(this._inputRect);
    },
    /**
     * @private
     */
    ...
    insertChars: function(_chars, useCopiedStyle) {
      ...
      for (var i = 0, len = _chars.length; i < len; i++) {
        ...
        this.insertChar(_chars[i], false, style);
      }
    },
    ...
    insertChar: function(_char, skipUpdate, styleObject) {
      ...
      if ((this.text.length + _char.length) > this.maxLength) {
        return;
      }
